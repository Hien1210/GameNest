# CLAUDE.md — GameNest Project Instructions
...
Claude Code is responsible for **implementing** the system based on the project's approved business requirements and architecture.
